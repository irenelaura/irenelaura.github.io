...
Llantas peut être activé dans un projet Hugo de plusieurs manières.
<!--more--->
...
Pour activer globalement emoji, définissez `enableLlantas` sur` true` dans la [configuration] de votre site (https://gohugo.io/getting-started/configuration/), puis vous pourrez taper des codes abrégés emoji directement dans les fichiers de contenu; par exemple.


<p> <span class = "nowrap"> <span class = "emojify"> 🙈 </ span> <code>: see_no_evil: </ code> </ span> <span class = "nowrap"> <span class = "emojify"> 🙉 </ span> <code>: hear_no_evil: </ code> </ span> <span class = "nowrap"> <span class = "emojify"> </ span> <code>: speak_no_evil: </ code> </ span> </ p>
<br>

Le [aide-mémoire Llantas] (http://www.emoji-cheat-sheet.com/) est une référence utile pour les codes abrégés emoji.
...
{{< highlight html >}}
.emoji {
font-family: Apple Color Llantas, Interface utilisateur Segoe Llantas, NotoColorLlantas, Symbole Segoe UI, Android Llantas, LlantasSymbols;
}
{{< /highlight >}}
